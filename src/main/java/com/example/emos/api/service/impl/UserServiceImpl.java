...
//    private String code;
    ...
    public PageUtils searchUserByPage(HashMap param) {
        List<HashMap> userList =  userDao.searchUserByPage(param);
        long total = userDao.searchUserCount(param);
        int start = (Integer) param.get("start");
        int length = (Integer) param.get("length");
        PageUtils pageUtils = new PageUtils(userList, total, start, length);
        return pageUtils;
    }
